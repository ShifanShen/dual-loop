...
FEEDBACK_TEST_SCOPE="${FEEDBACK_TEST_SCOPE:-public}"
FINAL_TEST_SCOPE="${FINAL_TEST_SCOPE:-private}"
...
ARGS=(
  ...
  --timeout "$TIMEOUT"
  --methods "$METHODS"
  --feedback_test_scope "$FEEDBACK_TEST_SCOPE"
...
echo "  feedback_test_scope=$FEEDBACK_TEST_SCOPE"
echo "  final_test_scope=$FINAL_TEST_SCOPE"
