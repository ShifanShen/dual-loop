...
\caption{Overview of the semantic-contract-based dual-loop framework: SAL gates specification revisions and freezes contract $s^\star$; IRL then repairs programs under it.}
\label{fig:framework}
\end{figure}
