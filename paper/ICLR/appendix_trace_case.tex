...
Figure~\ref{fig:trace} reports the final-aligned trace counts. Its path labels identify where recorded state changed, not which loop alone caused the final outcome. Likewise, a residual specification-side label records semantic evidence such as a weak accepted specification or unresolved obligation, whereas an implementation-side label requires sufficiently clear contract and verifier evidence. The conservative policy therefore treats these labels as audit cues rather than ground-truth causes.
