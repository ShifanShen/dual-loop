\medskip
\noindent\textbf{RQ4: What semantic and implementation evidence does the trace expose?}

\begin{figure}[t]
\centering
\includegraphics[width=\linewidth]{pics/trace_evidence_cn.png}
\caption{Final-aligned trace evidence over all 1,055 LiveCodeBench release\_v6 problems. The bar partitions the release into 401 solved paths, split by which loop recorded a state change, and 654 residual traces carrying specification-side, implementation-side, or unknown evidence.}
\label{fig:trace}
\end{figure}
